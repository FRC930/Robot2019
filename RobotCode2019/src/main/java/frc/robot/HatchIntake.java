...
public class HatchIntake {
    ...
    // Responsible for controlling the beak opening and closing and the hatch piston
    ...
    public void run(boolean isDriverButtonPressed, boolean isCoDriverButtonPressed) {
        ...
        if (!isDriverButtonPressed) {
            ...
            // TeleopHandler.getInstance().setRumble(Constants.DRIVER_CONTROLLER_ID,
            // Constants.RUMBLE_STOP);
        ...
        // If LT is held for at least 1 sec, flag for using auto hatch pickup is set to
        // true
