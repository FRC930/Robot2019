...
public class Constants {
	 ...
	 * 
	 * AT COMPETITION, PLEASE COPY THESE VALUES AND REPLACE THEM WITH THE CURRENT
	 * VALUES IN THE Elevator Constants SECTION
	 * 
	 * COMPETITION: ELEVATOR:
	 */

	/*
	 * public double ELEVATOR_KP_VALUE = 2.0; public double ELEVATOR_KI_VALUE = 0.0;
	 * public double ELEVATOR_KD_VALUE = 0.0; public int ELEVATOR_KV_VALUE = 600;
	 * public int ELEVATOR_KA_VALUE = 800; public int ELEVATOR_REVERSE_MULTIPLIER =
	 * 1; //talons on elevator.java should be commented and victors uncommented
	 * (line 30 in elevator.java) //set sensor as false (line 109 in Elevator.java)
	 * old values public int ELEVATOR_ROCKET_LEVEL_ONE_CARGO_VALUE = -10; public int
	 * ELEVATOR_ROCKET_LEVEL_TWO_CARGO_VALUE = -1485; public int
	 * ELEVATOR_ROCKET_LEVEL_THREE_CARGO_VALUE = -3645;
	 * 
	 * public int ELEVATOR_ROCKET_LEVEL_ONE_HATCH_VALUE = -612; public int
	 * ELEVATOR_ROCKET_LEVEL_TWO_HATCH_VALUE = -2745; public int
	 * ELEVATOR_ROCKET_LEVEL_THREE_HATCH_VALUE = -4865;
	 * 
	 * new values 4/24/19 public int ELEVATOR_ROCKET_LEVEL_ONE_CARGO_VALUE =
	 * -675;//10; public int ELEVATOR_ROCKET_LEVEL_TWO_CARGO_VALUE = -2745;//1485;
	 * public int ELEVATOR_ROCKET_LEVEL_THREE_CARGO_VALUE = -4865;//3645; public int
	 * ELEVATOR_CARGO_INTAKE_POSITION = -200;
	 * 
	 * public int ELEVATOR_ROCKET_LEVEL_ONE_HATCH_VALUE = -425; public int
	 * ELEVATOR_ROCKET_LEVEL_TWO_HATCH_VALUE = -2745; public int
	 * ELEVATOR_ROCKET_LEVEL_THREE_HATCH_VALUE = -4865;
	 * 
	 */
	...
	/*
	 * PRACTICE NUMBER 1: ELEVATOR:
	 * 
	 * WHEN USING THE PRACTICE ROBOT, PLEASE COPY THESE VALUES AND REPLACE THEM WITH
	 * THE CURRENT VALUES IN THE Elevator Constants SECTION
	 * 
	 * public double ELEVATOR_KP_VALUE = 6; public double ELEVATOR_KI_VALUE = 0;
	 * public double ELEVATOR_KD_VALUE = 0; public int ELEVATOR_KV_VALUE = 600;
	 * public int ELEVATOR_KA_VALUE = 500; public int ELEVATOR_REVERSE_MULTIPLIER =
	 * -1;
	 * 
	 * //victors on elevator should be commented and talons uncommented //set sensor
	 * as false old values public int ELEVATOR_ROCKET_LEVEL_ONE_CARGO_VALUE = 10;
	 * public int ELEVATOR_ROCKET_LEVEL_TWO_CARGO_VALUE = 1485; public int
	 * ELEVATOR_ROCKET_LEVEL_THREE_CARGO_VALUE = 3645;
	 * 
	 * public int ELEVATOR_ROCKET_LEVEL_ONE_HATCH_VALUE = 425; public int
	 * ELEVATOR_ROCKET_LEVEL_TWO_HATCH_VALUE = 2745; public int
	 * ELEVATOR_ROCKET_LEVEL_THREE_HATCH_VALUE = 4865;
	 * 
	 * new values public int ELEVATOR_ROCKET_LEVEL_ONE_CARGO_VALUE = -675;//10;
	 * public int ELEVATOR_ROCKET_LEVEL_TWO_CARGO_VALUE = -2745;//1485; public int
	 * ELEVATOR_ROCKET_LEVEL_THREE_CARGO_VALUE = -4865;//3645; public int
	 * ELEVATOR_CARGO_INTAKE_POSITION = -200;
	 * 
	 * public int ELEVATOR_ROCKET_LEVEL_ONE_HATCH_VALUE = -425; public int
	 * ELEVATOR_ROCKET_LEVEL_TWO_HATCH_VALUE = -2745; public int
	...
	/*
	 * NAMING CONVENTIONS FOR CONSTANTS Exceptions Must Be Talked About With Sam Or
	 * Devin* <Subsystem>_<Specific Robot Function>_<1-2 word description>
	 * 
	 * Ex. TELEOPH_INTAKE_SLOWLIFT DRIVE_LEFTWHEEL_AUTOSPEED
	 * 
	 */
	...
	/*
	 * public int ELEVATOR_ROCKET_LEVEL_ONE_CARGO_VALUE = -10; // public int
	 * ELEVATOR_ROCKET_LEVEL_TWO_CARGO_VALUE = -1485; //-1420 //-1485 old //1742
	 * public int ELEVATOR_ROCKET_LEVEL_THREE_CARGO_VALUE = -3645; //-3534 //-3645
	 * old //3874
	 * 
	 * public int ELEVATOR_ROCKET_LEVEL_ONE_HATCH_VALUE = -612; //-428 //-612 old
	 * public int ELEVATOR_ROCKET_LEVEL_TWO_HATCH_VALUE = -2745; //-2480 //-2745 old
	 * //2646 public int ELEVATOR_ROCKET_LEVEL_THREE_HATCH_VALUE = -4865; //-4565
	 * //-4865 old //4740
	 */
